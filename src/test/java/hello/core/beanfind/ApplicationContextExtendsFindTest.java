...
public class ApplicationContextExtendsFindTest {
	...
	void findBeanByParentTypeDuplicate(TestInfo testInfo) {
	...
	void findBeanByBeanName(TestInfo testInfo) {
		System.out.println("testInfo.getDisplayName() = " + testInfo.getDisplayName());
	...
	void findBeanByChildType(TestInfo testInfo) {
		System.out.println("testInfo.getDisplayName() = " + testInfo.getDisplayName());
	...
	void findAllBeanByParentType(TestInfo testInfo) {
		System.out.println("testInfo.getDisplayName() = " + testInfo.getDisplayName());
	...
	@Test
	@DisplayName("Object(최상위 부모) 타입으로 모두 조회하기")
	void findAllBeanByObjectType(TestInfo testInfo) {
		System.out.println("testInfo.getDisplayName() = " + testInfo.getDisplayName());
